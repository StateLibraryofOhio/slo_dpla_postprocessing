...
<!--
     ...
     Instructions within this file are specific to the kent_postcard
     dataset.
-->

<xsl:mode on-no-match="shallow-copy"/>

  <xsl:template match="//record[./metadata/oai_qdc:qualifieddc/dc:source[text()='KSU holdings available on other digital platforms']]"/>
