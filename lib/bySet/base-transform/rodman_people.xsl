...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Alliance, Ohio People</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="rodman_people"/>           <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dcterms:spatial"          mode="rodman_people"/>           <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="rodman_people"/>           <!-- create dcterms:contributor                                 -->
      ...
      <xsl:apply-templates select="dcterms:license"          mode="rodman_people"/>           <!-- unwanted; remove                                           -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:contributor" mode="rodman_people"/>                                 <!-- unwanted; remove                                           -->
  <xsl:template match="dcterms:license" mode="rodman_people"/>                                <!-- unwanted; remove                                           -->

  <xsl:template match="dcterms:spatial" mode="rodman_people">
  ...
  <xsl:template match="dc:identifier" mode="rodman_people">
    <xsl:choose>
