...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">Shaker Heights Public Library</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Shaker Heights Cleveland Press Photographs</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dcterms:isPartOf"         mode="shaker_press"/>            <!-- create dc:relation                                         -->
      ...
      <xsl:apply-templates select="dc:source"                mode="shaker_press"/>            <!-- unwanted; remove                                           -->
  ...
  <xsl:template match="dc:source" mode="shaker_press"/>
  <xsl:template match="dcterms:isPartOf" mode="shaker_press"/>
