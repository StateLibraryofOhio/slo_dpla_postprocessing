...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Lorain Catholic High School Yearbooks 1972-1989</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="lorainpl_11"/>             <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
  ...
  <xsl:template match="dc:identifier" mode="lorainpl_11">
    <xsl:choose>
