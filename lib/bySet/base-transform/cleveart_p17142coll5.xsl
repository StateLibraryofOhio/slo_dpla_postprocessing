...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Cleveland Museum of Art Inaugural Exhibition Posters</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="cleveart_p17142coll5"/>    <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dcterms:bibliographicCitation"         mode="cleveart_p17142coll5"/>

    </oai_qdc:qualifieddc>
  </xsl:template>


  <xsl:template match="dcterms:bibliographicCitation" mode="cleveart_p17142coll5"/>

  <xsl:template match="dc:rights" mode="cleveart_p17142coll5">
    <xsl:choose>
