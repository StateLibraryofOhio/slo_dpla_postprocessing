...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Caleb Emerson Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="mariettacollege_emerson"/> <!-- create dcterms:creator                                     -->
  ...
  <xsl:template match="dc:creator" mode="mariettacollege_emerson">
