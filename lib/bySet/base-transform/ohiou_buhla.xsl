...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Frank Buhla Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="ohiou_buhla"/>             <!-- create dcterms:creator                                     -->
      <xsl:apply-templates select="dc:date"                  mode="ohiou_buhla"/>             <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="ohiou_buhla"/>             <!-- create dc:format                                           -->
      <xsl:apply-templates select="dcterms:spatial"          mode="ohiou_buhla"/>             <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="ohiou_buhla"/>             <!-- create dcterms:contributor                                 -->
      ...
      <xsl:apply-templates select="dcterms:isReferencedBy"   mode="ohiou_buhla"/>             <!-- create IIIF metadata                                       -->
      <xsl:apply-templates select="dc:publisher"             mode="odn"/>                     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="ohiou_buhla"/>             <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="ohiou_buhla"/>             <!-- create dc:relation                                         -->
  ...
  <xsl:template match="dcterms:isPartOf" mode="ohiou_buhla"/>

  <xsl:template match="dc:relation" mode="ohiou_buhla"/>

  <xsl:template match="dcterms:isReferencedBy" mode="ohiou_buhla"/>

  <xsl:template match="dc:date" mode="ohiou_buhla">
  ...
  <xsl:template match="dc:format" mode="ohiou_buhla">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:spatial" mode="ohiou_buhla">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:contributor" mode="ohiou_buhla">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:creator" mode="ohiou_buhla">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
