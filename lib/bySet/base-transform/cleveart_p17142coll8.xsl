...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">John Paul Miller Renderings</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="cleveart_p17142coll8"/>    <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      <xsl:apply-templates select="dc:rights"                mode="cleveart_p17142coll8"/>    <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:subject"               mode="cleveart_p17142coll8"/>    <!-- create dcterms:subject                                     -->
      ...
      <xsl:apply-templates select="dcterms:medium" mode="cleveart_p17142coll8"/>              <!-- create dc:format                                           -->

      <xsl:apply-templates select="dcterms:bibliographicCitation"  mode="cleveart_p17142coll8"/>    <!-- unwanted; remove                                     -->


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dcterms:bibliographicCitation"  mode="cleveart_p17142coll8"/>

  <xsl:template match="dcterms:medium" mode="cleveart_p17142coll8">
    <xsl:element name="dc:format" namespace="http://purl.org/dc/elements/1.1/">
      <xsl:value-of select="normalize-space(.)"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:subject" mode="cleveart_p17142coll8">
  ...
  <xsl:template match="dc:rights" mode="cleveart_p17142coll8">
    <xsl:choose>
  ...
  <xsl:template match="dc:identifier" mode="cleveart_p17142coll8">
    <xsl:choose>
