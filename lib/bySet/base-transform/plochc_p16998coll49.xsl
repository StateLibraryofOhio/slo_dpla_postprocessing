...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Saints Peter and Paul Cemetery collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:date"                  mode="plochc_p16998coll49"/>     <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="plochc_p16998coll49"/>     <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dcterms:extent"           mode="plochc_p16998coll49"/>     <!-- create dcterms:extent                                      -->
                                                                                              <!-- dcterms:identifier is created above as part of the edm:isShownAt transform -->
      <xsl:copy-of         select="dcterms:isReferencedBy"   copy-namespaces="no"/>           <!-- create IIIF metadata                                       -->
      <xsl:apply-templates select="dc:publisher"             mode="plochc_p16998coll49"/>     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="plochc_p16998coll49"/>     <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="odn"/>                     <!-- create dc:relation                                         -->
                                                                                              <!-- dc:rights is created above as part of the edm:rights transform -->
      <xsl:apply-templates select="dcterms:rightsHolder"     mode="plochc_p16998coll49"/>     <!-- create dcterms:rightsHolder                                -->
      ...
      <xsl:apply-templates select="dcterms:tableOfContents"  mode="plochc_p16998coll49"/>
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll49"/>
      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll49"/>

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:date" mode="plochc_p16998coll49"/>
  <xsl:template match="dc:publisher" mode="plochc_p16998coll49"/>
  <xsl:template match="dcterms:tableOfContents" mode="plochc_p16998coll49"/>
  <xsl:template match="dc:relation" mode="plochc_p16998coll49"/>
  <xsl:template match="dc:format" mode="plochc_p16998coll49"/>
  <xsl:template match="dcterms:extent" mode="plochc_p16998coll49"/>
  <xsl:template match="dcterms:license" mode="plochc_p16998coll49"/>
  <xsl:template match="dcterms:rightsHolder" mode="plochc_p16998coll49"/>

  <xsl:template match="dcterms:medium" mode="plochc_p16998coll49">
