...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Todd Light collection on Lillian Gish</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="bgsu_187"/>                <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="bgsu_187"/>                <!-- create dcterms:creator                                     -->
      ...
      <xsl:apply-templates select="dcterms:created"          mode="bgsu_187"/>
  ...
  <xsl:template match="dc:creator" mode="bgsu_187">
  ...
  <xsl:template match="dcterms:created" mode="bgsu_187"/>

  <xsl:template match="dc:identifier" mode="bgsu_187">
    <xsl:choose>
