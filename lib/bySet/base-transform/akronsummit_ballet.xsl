...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">Akron-Summit County Public Library</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Ohio Ballet Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="akronsummit_ballet"/>      <!-- create dcterms:creator and dcterms:rightsHolder            -->
      ...
      <xsl:apply-templates select="dc:relation"              mode="akronsummit_ballet"/>      <!-- create dc:relation                                         -->
  ...
  <xsl:template match="dc:relation" mode="akronsummit_ballet"/>

  <xsl:template match="dc:creator" mode="akronsummit_ballet">
