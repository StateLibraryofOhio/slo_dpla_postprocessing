...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <!-- removing the normal, hard-coding of dcterms:isPartOf because this OAI set contains multiple, discrete collections -->
      ...
      <xsl:apply-templates select="dc:language"              mode="ohiou_mss"/>               <!-- create dcterms:language                                    -->
      <xsl:apply-templates select="dc:creator"               mode="ohiou_mss"/>               <!-- create dcterms:creator                                     -->
      <xsl:apply-templates select="dc:date"                  mode="ohiou_mss"/>               <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="ohiou_mss"/>               <!-- create dc:format                                           -->
      <xsl:apply-templates select="dcterms:spatial"          mode="ohiou_mss"/>               <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dcterms:isReferencedBy"   mode="ohiou_mss"/>               <!-- unwanted; eliminate                                        -->
      <xsl:apply-templates select="dc:publisher"             mode="ohiou_mss"/>               <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="ohiou_mss"/>               <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="ohiou_mss"/>               <!-- create dcterms:isPartOf                                    -->
                                                                                              <!-- dc:rights is created above as part of the edm:rights transform -->
      <xsl:apply-templates select="dcterms:rightsHolder"     mode="ohiou_mss"/>               <!-- create dcterms:rightsHolder                                -->
  ...
  <xsl:template match="dcterms:isReferencedBy" mode="ohiou_mss"/>

  <xsl:template match="dc:relation" mode="ohiou_mss"/>
  ...
  <xsl:template match="dcterms:spatial" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:language" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:creator" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:contributor" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:format" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:type" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:date" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:isPartOf" mode="ohiou_mss">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
