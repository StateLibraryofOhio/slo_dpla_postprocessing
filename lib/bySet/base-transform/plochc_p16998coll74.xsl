...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Cincinnati Health Department</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:date"                  mode="plochc_p16998coll74"/>     <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="plochc_p16998coll74"/>     <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dcterms:extent"           mode="plochc_p16998coll74"/>     <!-- create dcterms:extent                                      -->
      ...
      <xsl:apply-templates select="dc:publisher"             mode="plochc_p16998coll74"/>     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="plochc_p16998coll74"/>     <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="odn"/>                     <!-- create dc:relation                                         -->
                                                                                              <!-- dc:rights is created above as part of the edm:rights transform -->
      <xsl:apply-templates select="dcterms:rightsHolder"     mode="plochc_p16998coll74"/>     <!-- create dcterms:rightsHolder                                -->
      ...
      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll74"/>
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll74"/>

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:relation" mode="plochc_p16998coll74"/>
  <xsl:template match="dc:format" mode="plochc_p16998coll74"/>
  <xsl:template match="dcterms:extent" mode="plochc_p16998coll74"/>
  <xsl:template match="dc:publisher" mode="plochc_p16998coll74"/>
  <xsl:template match="dcterms:license" mode="plochc_p16998coll74"/>
  <xsl:template match="dcterms:rightsHolder" mode="plochc_p16998coll74"/>

  <xsl:template match="dcterms:medium" mode="plochc_p16998coll74">
    <xsl:element name="dc:format" namespace="http://purl.org/dc/elements/1.1/">
      <xsl:value-of select="."/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:date" mode="plochc_p16998coll74">
