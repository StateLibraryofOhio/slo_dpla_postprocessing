...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">The Ohio State University Libraries</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Rare Books and Manuscripts Library</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="osu_xp68kg24f"/>           <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:coverage"              mode="osu_xp68kg24f"/>           <!-- create dcterms:spatial -->


      <xsl:apply-templates select="dc:source"                mode="osu_xp68kg24f"/>           <!-- unwanted; remove -->
      <xsl:apply-templates select="dc:relation"              mode="osu_xp68kg24f"/>           <!-- unwanted; remove -->


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="osu_xp68kg24f"/>

  <xsl:template match="dc:relation" mode="osu_xp68kg24f"/>

  <xsl:template match="dc:coverage" mode="osu_xp68kg24f">
  ...
  <xsl:template match="dc:identifier" mode="osu_xp68kg24f">
    <xsl:choose>
