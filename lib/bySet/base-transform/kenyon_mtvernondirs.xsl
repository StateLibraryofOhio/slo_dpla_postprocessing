...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Mount Vernon City Directories</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_mtvernondirs"/>     <!-- create edm:isShownAt, and dcterms:identifier -->
      ...
      <xsl:apply-templates select="dc:date.created"          mode="kenyon_mtvernondirs"/>     <!-- create dc:date                            -->
      ...
      <xsl:apply-templates select="dc:description"           mode="kenyon_mtvernondirs"/>     <!-- create edm:preview                        -->
      <xsl:apply-templates select="dc:description.abstract"  mode="kenyon_mtvernondirs"/>     <!-- create dcterms:description                -->
  ...
  <xsl:template match="dc:date.created" mode="kenyon_mtvernondirs">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_mtvernondirs">
    <xsl:choose>
  ...
  <xsl:template match="dc:description" mode="kenyon_mtvernondirs">
    <xsl:element name="edm:preview" namespace="http://www.europeana.eu/schemas/edm/">
      <xsl:value-of select="normalize-space(.)"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:description.abstract" mode="kenyon_mtvernondirs">
