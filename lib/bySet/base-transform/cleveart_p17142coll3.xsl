...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">John Paul Miller in Bodie, California, 1946</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="cleveart_p17142coll3"/>    <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dcterms:medium"           mode="cleveart_p17142coll3"/>    <!-- create dc:format                                           -->

      <xsl:apply-templates select="dcterms:bibliographicCitation"  mode="cleveart_p17142coll3"/>   <!-- unwanted; remove                                      -->

    </oai_qdc:qualifieddc>
  </xsl:template>


  <xsl:template match="dcterms:bibliographicCitation" mode="cleveart_p17142coll3"/>

  <xsl:template match="dcterms:medium" mode="cleveart_p17142coll3">
  ...
  <xsl:template match="dc:rights" mode="cleveart_p17142coll3">
    <xsl:choose>
  ...
  <xsl:template match="dc:identifier" mode="cleveart_p17142coll3">
    <xsl:choose>
