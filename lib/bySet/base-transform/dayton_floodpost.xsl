...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">1913 Flood Postcards</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:relation"              mode="dayton_floodpost"/>        <!-- create dc:relation                                         -->
  ...
  <xsl:template match="dc:relation" mode="dayton_floodpost"/>
