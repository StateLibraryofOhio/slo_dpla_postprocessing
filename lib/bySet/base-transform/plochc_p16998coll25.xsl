...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Coronavirus Pandemic in Cincinnati</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:format"                mode="plochc_p16998coll25"/>     <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dcterms:extent"           mode="plochc_p16998coll25"/>     <!-- create dcterms:extent                                      -->
                                                                                              <!-- dcterms:identifier is created above as part of the edm:isShownAt transform -->
      <xsl:apply-templates select="dc:publisher"             mode="plochc_p16998coll25"/>     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="plochc_p16998coll25"/>     <!-- create dc:relation                                         -->
      ...
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll25"/>     <!-- create dc:format                                           -->

      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll25"/>     <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:rightsHolder"     mode="plochc_p16998coll25"/>     <!-- unwanted; remove                                           -->


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:format" mode="plochc_p16998coll25"/>

  <xsl:template match="dc:relation" mode="plochc_p16998coll25"/>

  <xsl:template match="dcterms:extent" mode="plochc_p16998coll25"/>

  <xsl:template match="dc:publisher" mode="plochc_p16998coll25"/>

  <xsl:template match="dcterms:license" mode="plochc_p16998coll25"/>

  <xsl:template match="dcterms:rightsHolder" mode="plochc_p16998coll25"/>


  <xsl:template match="dcterms:medium" mode="plochc_p16998coll25">
