...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Mellor Gold Rush Letters</xsl:element>              <!-- create dcterms:isPartOf -->
  ...
  <xsl:template match="dcterms:isPartOf" mode="mariettacollege_mellor" />
