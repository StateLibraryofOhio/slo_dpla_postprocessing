...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Stories of Knox County Images</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_sokcimages"/>       <!-- create edm:isShownAt -->
      ...
      <xsl:apply-templates select="dc:format"                mode="kenyon_sokcimages"/>       <!-- create dc:format                          -->
      ...
      <xsl:apply-templates select="dc:description"           mode="kenyon_sokcimages"/>       <!-- create dcterms:description                -->
  ...
  <!-- junk data in their dc:format; do not use. -->

  <xsl:template match="dc:format" mode="kenyon_sokcimages"/>

  <!-- use the dc:identifier to populate edm:isShownAt -->
  <xsl:template match="dc:identifier" mode="kenyon_sokcimages">
    <xsl:choose>
  ...
  <xsl:template match="dc:description" mode="kenyon_sokcimages">
