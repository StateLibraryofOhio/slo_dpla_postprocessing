...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">The Monocle - Monroe Local School District High School Yearbooks</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:format"                mode="midpointe_monroehs"/>      <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dc:coverage"              mode="midpointe_monroehs"/>      <!-- create dcterms:spatial                                     -->
      <xsl:apply-templates select="dc:source"                mode="midpointe_monroehs"/>      <!-- discard                                                    -->
  ...
  <xsl:template match="dc:format" mode="midpointe_monroehs">
    <xsl:for-each select="tokenize(., ';')">
  ...
  <xsl:template match="dc:source" mode="midpointe_monroehs"/>
