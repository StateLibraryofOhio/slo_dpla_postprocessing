...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Southview High School Yearbooks 1972-2009</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="lorainpl_12"/>             <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:format"                mode="lorainpl_12"/>             <!-- create dc:format                                           -->
  ...
  <xsl:template match="dc:format" mode="lorainpl_12"/>

  <xsl:template match="dc:identifier" mode="lorainpl_12">
    <xsl:choose>
