...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Trailblazing Women in Ohio Politics Oral History Collection</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="bgsu_161"/>                <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
  ...
  <xsl:template match="dc:identifier" mode="bgsu_161">
    <xsl:choose>
