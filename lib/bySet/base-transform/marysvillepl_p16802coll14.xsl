...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Marysville High School Yearbooks</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="marysvillepl_p16802coll14"/> <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      <xsl:copy-of         select="dc:rights"                copy-namespaces="no"/>             <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:type"                  mode="marysvillepl_p16802coll14"/> <!-- create dcterms:type                                        -->
      ...
      <xsl:apply-templates select="dcterms:accessRights"     mode="marysvillepl_p16802coll14"/>  <!-- create edm:rights -->
    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:identifier" mode="marysvillepl_p16802coll14">
    <xsl:choose>
  ...
  <xsl:template match="dcterms:accessRights" mode="marysvillepl_p16802coll14">
  ...
  <xsl:template match="dc:type" mode="marysvillepl_p16802coll14"/>
