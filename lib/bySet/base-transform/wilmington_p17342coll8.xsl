...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">Wilmington College</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Voyage of the Phoenix</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="wilmington_p17342coll8"/>  <!-- create dcterms:creator                                     -->
      ...
      <xsl:apply-templates select="dc:source"                mode="wilmington_p17342coll8"/>  <!-- create dcterms:temporal                                    -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="wilmington_p17342coll8"/>

  <xsl:template match="dc:creator" mode="wilmington_p17342coll8">
