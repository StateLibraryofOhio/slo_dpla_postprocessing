...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Medieval Manuscripts</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_mdvlmanuscripts"/>  <!-- create edm:isShownAt, edm:preview, and dcterms:identifier -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="kenyon_mdvlmanuscripts"/>  <!-- create dcterms:creator                    -->
      ...
      <xsl:apply-templates select="dc:format.medium"         mode="kenyon_mdvlmanuscripts"/>  <!-- create dc:format                          -->
      <xsl:apply-templates select="dc:format.extent"         mode="kenyon_mdvlmanuscripts"/>  <!-- create dc:format                          -->
      <xsl:copy-of         select="dcterms:spatial"          copy-namespaces="no"/>           <!-- create dcterms:spatial                    -->
      <xsl:apply-templates select="dc:coverage.spatial"      mode="kenyon_mdvlmanuscripts"/>  <!-- create dcterms:spatial                    -->
      ...
      <xsl:apply-templates select="dc:description"           mode="kenyon_mdvlmanuscripts"/>  <!-- create edm:preview                        -->
      <xsl:apply-templates select="dc:description.abstract"  mode="kenyon_mdvlmanuscripts"/>  <!-- create dcterms:description                -->
      ...
      <xsl:apply-templates select="dc:relation.isPartOf"     mode="kenyon_mdvlmanuscripts"/>  <!-- create dc:relation                        -->
      ...
      <xsl:apply-templates select="dc:dcterms.provenance"    mode="kenyon_mdvlmanuscripts"/>  <!-- unwanted, eliminate.  Also, I suspect that this element is simply not configured properly. -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:dcterms.provenance" mode="kenyon_mdvlmanuscripts"/>

  <xsl:template match="dc:format.medium" mode="kenyon_mdvlmanuscripts">
    <xsl:element name="dc:format" namespace="http://purl.org/dc/elements/1.1/">
      <xsl:value-of select="normalize-space(.)"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:format.extent" mode="kenyon_mdvlmanuscripts">
    <xsl:element name="dc:format" namespace="http://purl.org/dc/elements/1.1/">
      <xsl:value-of select="normalize-space(.)"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:coverage.spatial" mode="kenyon_mdvlmanuscripts">
    <xsl:element name="dcterms:spatial" namespace="http://purl.org/dc/terms/">
      <xsl:value-of select="."/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:relation.isPartOf" mode="kenyon_mdvlmanuscripts">
    <xsl:element name="dc:relation" namespace="http://purl.org/dc/elements/1.1/">
      <xsl:value-of select="normalize-space(.)"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:description.abstract" mode="kenyon_mdvlmanuscripts">
    <xsl:element name="dcterms:description" namespace="http://purl.org/dc/terms/">
      <xsl:value-of select="."/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:description" mode="kenyon_mdvlmanuscripts">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_mdvlmanuscripts">
    <xsl:choose>
  ...
  <xsl:template match="dc:creator" mode="kenyon_mdvlmanuscripts">
