...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Stratford</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="delawaremem_stratford"/>   <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      <xsl:apply-templates select="dc:rights"                mode="delawaremem_stratford"/>   <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:type"                  mode="delawaremem_stratford"/>   <!-- create dcterms:type                                        -->
  ...
  <xsl:template match="dc:identifier" mode="delawaremem_stratford">
    <xsl:choose>
  ...
  <xsl:template match="dc:type" mode="delawaremem_stratford">
    <xsl:for-each select=".">
  ...
  <xsl:template match="dc:rights" mode="delawaremem_stratford">
    <xsl:for-each select="tokenize(., '&#xA;')">
