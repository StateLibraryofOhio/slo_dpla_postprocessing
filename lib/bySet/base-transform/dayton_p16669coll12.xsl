...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">#DaytonStrong Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:source"                mode="dayton_p16669coll12"/>

      <xsl:apply-templates select="dc:coverage"              mode="dayton_p16669coll12"/>

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="dayton_p16669coll12"/>

  <xsl:template match="dc:coverage" mode="dayton_p16669coll12">
