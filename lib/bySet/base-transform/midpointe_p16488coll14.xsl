...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="text()|@*"/>
    <xsl:template match="//oai_qdc:qualifieddc">
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Harold and Carolyn Kramer Photograph Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:format"           mode="midpointe_p16488coll14"/>    <!-- create dc:format                        -->
      <xsl:copy-of         select="dcterms:spatial"     copy-namespaces="no"/>             <!-- create dcterms:spatial                  -->
      <xsl:apply-templates select="dc:subject"          mode="midpointe_p16488coll14"/>    <!-- create dcterms:subject                  -->
  ...
  <xsl:template match="dc:subject" mode="midpointe_p16488coll14">
  ...
  <xsl:template match="dc:format" mode="midpointe_p16488coll14">
    <xsl:for-each select="tokenize(., ';')">
  ...
  <xsl:template match="dc:publisher" mode="midpointe_p16488coll14">
