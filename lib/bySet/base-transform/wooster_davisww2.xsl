...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Robert D. Davis World War II Collection</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="wooster_davisww2"/>          <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:date.created"          mode="wooster_davisww2"/>          <!-- create dc:date                                             -->
      ...
      <xsl:apply-templates select="dc:coverage.spatial.lat"  mode="wooster_davisww2"/>          <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:description"           mode="wooster_davisww2"/>          <!-- create edm:preview                                         -->
      <xsl:apply-templates select="dc:description.abstract"  mode="wooster_davisww2"/>          <!-- create dcterms:description                                 -->
  ...
  <xsl:template match="dc:description.abstract" mode="wooster_davisww2">
  ...
  <xsl:template match="dc:rights" mode="wooster_davisww2">
    <xsl:element name="edm:rights" namespace="http://www.europeana.eu/schemas/edm/">
      <xsl:value-of select="normalize-space(.)"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:identifier" mode="wooster_davisww2">
