...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Piranesi's "Views of Rome"</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_piranesi"/>         <!-- create edm:isShownAt, edm:preview, and dcterms:identifier -->
      ...
      <xsl:apply-templates select="dc:date.created"          mode="kenyon_piranesi"/>
      ...
      <xsl:apply-templates select="dc:coverage.spatial"      mode="kenyon_piranesi"/>         <!-- create dcterms:spatial                    -->
      ...
      <xsl:apply-templates select="dc:description"           mode="kenyon_piranesi"/>         <!-- create dcterms:description                -->
      <xsl:apply-templates select="dc:description.abstract"  mode="kenyon_piranesi"/>         <!-- create dcterms:description                -->
  ...
  <xsl:template match="dc:date.created" mode="kenyon_piranesi">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_piranesi">
    <xsl:choose>
  ...
  <xsl:template match="dc:description" mode="kenyon_piranesi">
  ...
  <xsl:template match="dc:description.abstract" mode="kenyon_piranesi">
  ...
  <xsl:template match="dc:coverage.spatial" mode="kenyon_piranesi">
