...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">             <!-- this may need to be changed if the server isn't running CONTENTdm -->
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">The Doris L Page Collection</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="midpointe_p16488coll22"/>  <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="midpointe_p16488coll22"/>  <!-- create dcterms:creator                                     -->
      <xsl:apply-templates select="dc:date"                  mode="midpointe_p16488coll22"/>  <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="midpointe_p16488coll22"/>  <!-- create dc:format                                           -->
      <xsl:copy-of         select="dcterms:spatial"          copy-namespaces="no"/>           <!-- create dcterms:spatial                                     -->
      <xsl:apply-templates select="dc:coverage"              mode="midpointe_p16488coll22"/>  <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="midpointe_p16488coll22"/>  <!-- create dcterms:contributor                                 -->
      <xsl:apply-templates select="dc:description"           mode="odn"/>                     <!-- create dcterms:description                                 -->
      <xsl:apply-templates select="dcterms:extent"           mode="midpointe_p16488coll22"/>  <!-- create dcterms:extent                                      -->
                                                                                              <!-- dcterms:identifier is created above as part of the edm:isShownAt transform -->
      <xsl:apply-templates select="dc:publisher"             mode="midpointe_p16488coll22"/>  <!-- create dcterms:publisher                                   -->
      ...
      <xsl:apply-templates select="dcterms:license"          mode="midpointe_p16488coll22"/>  <!-- create edm:rights                                          -->
      <xsl:apply-templates select="dc:source"                mode="midpointe_p16488coll22"/>  <!-- discard dc:source                                          -->


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="midpointe_p16488coll22"/>

  <xsl:template match="dc:identifier" mode="midpointe_p16488coll22">
    <xsl:choose>
  ...
  <xsl:template match="dcterms:extent" mode="midpointe_p16488coll22">
  ...
  <xsl:template match="dc:contributor" mode="midpointe_p16488coll22">
  ...
  <xsl:template match="dc:publisher" mode="midpointe_p16488coll22">
    <xsl:for-each select="tokenize(normalize-space(.), ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:creator" mode="midpointe_p16488coll22">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:format" mode="midpointe_p16488coll22">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:date" mode="midpointe_p16488coll22">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:license" mode="midpointe_p16488coll22">
  ...
  <xsl:template match="dc:coverage" mode="midpointe_p16488coll22">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
