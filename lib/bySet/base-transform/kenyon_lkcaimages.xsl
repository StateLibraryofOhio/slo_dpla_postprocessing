...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="odn_templates.xsl"/>
    ...
    <xsl:template match="//oai_dc:dc">
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Latinos in Rural America Photographs</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_lkcaimages"/>       <!-- create edm:isShownAt                 -->
      ...
      <xsl:apply-templates select="dc:date.created"          mode="kenyon_lkcaimages"/>
      ...
      <xsl:apply-templates select="dc:description"           mode="kenyon_lkcaimages"/>       <!-- create edm:preview                        -->
      <xsl:apply-templates select="dc:description.abstract"  mode="kenyon_lkcaimages"/>       <!-- create dcterms:description                -->
  ...
  <xsl:template match="dc:date.created" mode="kenyon_lkcaimages">
  ...
  <xsl:template match="dc:description" mode="kenyon_lkcaimages">
  ...
  <xsl:template match="dc:description.abstract" mode="kenyon_lkcaimages">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_lkcaimages">
    <xsl:choose>
