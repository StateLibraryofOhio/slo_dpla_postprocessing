...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Cleveland Museum of Art Fine Arts Garden scrapbooks</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="cleveart_p17142coll13"/>   <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:source"                mode="cleveart_p17142coll13"/>    <!-- create dc:relation -->

      <xsl:apply-templates select="dcterms:bibliographicCitation"   mode="cleveart_p17142coll13"/>  <!-- unwanted; eliminate -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:rights" mode="cleveart_p17142coll13">
  ...
  <xsl:template match="dc:source" mode="cleveart_p17142coll13">
    <xsl:element name="dc:relation" namespace="http://purl.org/dc/elements/1.1/">
      <xsl:value-of select="."/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dcterms:bibliographicCitation" mode="cleveart_p17142coll13"/>
