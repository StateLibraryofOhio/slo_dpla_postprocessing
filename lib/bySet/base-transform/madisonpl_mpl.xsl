...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">Madison Public Library</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Madison Public Library Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="madisonpl_mpl"/>           <!-- create dcterms:creator                                     -->
      ...
      <xsl:apply-templates select="dcterms:isPartOf"         mode="madisonpl_mpl"/>           <!-- unwanted; remove -->
      <xsl:apply-templates select="dc:source"                mode="madisonpl_mpl"/>           <!-- unwanted; remove -->
