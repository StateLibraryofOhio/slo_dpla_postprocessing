...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="text()|@*"/>
    <xsl:template match="//oai_dc:dc">
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Kenyon College Course Catalogs</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_coursecatalogs"/>   <!-- create edm:isShownAt                 -->
      ...
      <xsl:apply-templates select="dc:date.created"          mode="kenyon_coursecatalogs"/>   <!-- create dc:date                            -->
      <xsl:apply-templates select="dc:format"                mode="odn"/>                     <!-- create dc:format                          -->
      <xsl:apply-templates select="dc:coverage.spatial"      mode="kenyon_coursecatalogs"/>   <!-- create dcterms:spatial                    -->
      ...
      <xsl:apply-templates select="dc:description"           mode="kenyon_coursecatalogs"/>   <!-- create edm:preview                        -->
  ...
  <xsl:template match="dc:coverage.spatial" mode="kenyon_coursecatalogs">
  ...
  <xsl:template match="dc:date.created" mode="kenyon_coursecatalogs">
  ...
  <xsl:template match="dc:description" mode="kenyon_coursecatalogs">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_coursecatalogs">
    <xsl:choose>
