...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">William Jackson Armstrong Manuscript Collection</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="ohmem_p16007coll35"/>      <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="ohmem_p16007coll35"/>      <!-- create dcterms:contributor                                 -->
      ...
      <xsl:apply-templates select="dc:relation"              mode="ohmem_p16007coll35"/>      <!-- create dc:relation                                         -->
      ...
      <xsl:apply-templates select="dc:source"                mode="ohmem_p16007coll35"/>      <!-- unwanted; remove                                           -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="ohmem_p16007coll35"/>

  <xsl:template match="dc:relation" mode="ohmem_p16007coll35"/>
  ...
  <xsl:template match="dc:identifier" mode="ohmem_p16007coll35">
    <xsl:choose>
  ...
  <xsl:template match="dc:contributor" mode="ohmem_p16007coll35">
