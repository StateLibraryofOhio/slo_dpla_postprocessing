...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Cleveland Museum of Art May Show Posters</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="cleveart_p17142coll10"/>   <!-- create edm:rights and dc:rights                            -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="cleveart_p17142coll10"/>   <!-- create dcterms:creator                                     -->
      ...
      <xsl:apply-templates select="dcterms:bibliographicCitation"   mode="cleveart_p17142coll10"/>    <!-- unwanted; remove                                   -->
      <xsl:apply-templates select="dc:source"                mode="cleveart_p17142coll10"/>           <!-- unwanted; remove                                   -->


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dcterms:bibliographicCitation" mode="cleveart_p17142coll10"/>

  <xsl:template match="dc:source" mode="cleveart_p17142coll10"/>

  <xsl:template match="dc:rights" mode="cleveart_p17142coll10">
    <xsl:choose>
      <xsl:when test="contains(lower-case(.), 'preferred citation')">
  ...
  <xsl:template match="dc:creator" mode="cleveart_p17142coll10">
