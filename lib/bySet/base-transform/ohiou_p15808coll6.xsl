...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Civil War Correspondence</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="ohiou_p15808coll6"/>       <!-- create dcterms:creator                                     -->
      <xsl:apply-templates select="dc:date"                  mode="ohiou_p15808coll6"/>       <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="ohiou_p15808coll6"/>       <!-- create dc:format                                           -->
      <xsl:apply-templates select="dcterms:spatial"          mode="ohiou_p15808coll6"/>       <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="ohiou_p15808coll6"/>       <!-- create dcterms:contributor                                 -->
      ...
      <xsl:apply-templates select="dcterms:isReferencedBy"   mode="ohiou_p15808coll6"/>       <!-- create IIIF metadata                                       -->
      <xsl:apply-templates select="dc:publisher"             mode="odn"/>                     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="ohiou_p15808coll6"/>       <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="ohiou_p15808coll6"/>       <!-- create dc:relation                                         -->
  ...
  <xsl:template match="dcterms:isReferencedBy" mode="ohiou_p15808coll6"/>


  <xsl:template match="dcterms:isPartOf" mode="ohiou_p15808coll6">
  ...
  <xsl:template match="dc:relation" mode="ohiou_p15808coll6">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
        <xsl:element name="dc:relation" namespace="http://purl.org/dc/elements/1.1/">
          <xsl:value-of select="."/>
  ...
  <xsl:template match="dc:format" mode="ohiou_p15808coll6">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:date" mode="ohiou_p15808coll6">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:creator" mode="ohiou_p15808coll6">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:contributor" mode="ohiou_p15808coll6">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:spatial" mode="ohiou_p15808coll6">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
