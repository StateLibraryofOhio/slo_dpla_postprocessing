...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Natural History Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="ohmem_p16007coll99"/>      <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="ohmem_p16007coll99"/>      <!-- create dcterms:creator                                     -->
      <xsl:apply-templates select="dc:date"                  mode="ohmem_p16007coll99"/>      <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="odn"/>                     <!-- create dc:format                                           -->
      <xsl:apply-templates select="dcterms:spatial"          mode="ohmem_p16007coll99"/>      <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="ohmem_p16007coll99"/>      <!-- create dcterms:contributor                                 -->
      <xsl:apply-templates select="dc:description"           mode="odn"/>                     <!-- create dcterms:description                                 -->
      <xsl:apply-templates select="dcterms:extent"           mode="ohmem_p16007coll99"/>      <!-- create dcterms:extent                                      -->
      ...
      <xsl:apply-templates select="dcterms:isPartOf"         mode="ohmem_p16007coll99"/>      <!-- create dc:relation                                         -->
      ...
      <xsl:apply-templates select="dcterms:medium"           mode="ohmem_p16007coll99"/>
      <xsl:apply-templates select="dcterms:license"          mode="ohmem_p16007coll99"/>


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:contributor" mode="ohmem_p16007coll99"/>
  <xsl:template match="dc:rights" mode="ohmem_p16007coll99"/>
  <xsl:template match="dcterms:extent" mode="ohmem_p16007coll99"/>

  <xsl:template match="dcterms:spatial" mode="ohmem_p16007coll99">
  ...
  <xsl:template match="dcterms:isPartOf" mode="ohmem_p16007coll99">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:creator" mode="ohmem_p16007coll99">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:license" mode="ohmem_p16007coll99">
  ...
  <xsl:template match="dcterms:medium" mode="ohmem_p16007coll99">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:date" mode="ohmem_p16007coll99">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
