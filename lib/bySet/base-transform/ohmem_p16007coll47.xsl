...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Ohio State of the State Addresses</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:language"              mode="ohmem_p16007coll47"/>      <!-- create dcterms:language                                    -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="ohmem_p16007coll47"/>      <!-- create dcterms:contributor                                 -->
      ...
      <xsl:apply-templates select="dc:relation"              mode="ohmem_p16007coll47"/>      <!-- create dc:relation                                         -->
  ...
  <xsl:template match="dc:relation" mode="ohmem_p16007coll47"/>

  <xsl:template match="dc:language" mode="ohmem_p16007coll47"/>

  <xsl:template match="dc:contributor" mode="ohmem_p16007coll47">
