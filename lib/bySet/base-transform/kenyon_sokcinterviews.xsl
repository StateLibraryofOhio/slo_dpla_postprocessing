...
<xsl:include href="odn_templates.xsl"/>
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Stories of Knox County Interviews</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"       mode="kenyon_sokcinterviews"/>       <!-- create edm:isShownAt                 -->
      ...
      <xsl:apply-templates select="dc:date.created"     mode="kenyon_sokcinterviews"/>       <!-- create dc:date                          -->
  ...
  <xsl:template match="dc:identifier" mode="kenyon_sokcinterviews">
    <xsl:choose>
  ...
  <xsl:template match="dc:date.created" mode="kenyon_sokcinterviews">
