...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Illustrations of the Nests and Eggs of Birds of Ohio</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="plochc_p16998coll59"/>     <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:format"                mode="plochc_p16998coll59"/>     <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll59"/>     <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="plochc_p16998coll59"/>     <!-- create dcterms:contributor                                 -->
      <xsl:apply-templates select="dc:description"           mode="odn"/>                     <!-- create dcterms:description                                 -->
      <xsl:apply-templates select="dcterms:extent"           mode="plochc_p16998coll59"/>     <!-- create dcterms:extent                                      -->
                                                                                              <!-- dcterms:identifier is created above as part of the edm:isShownAt transform -->
      <xsl:apply-templates select="dc:publisher"             mode="plochc_p16998coll59"/>     <!-- create dcterms:publisher                                   -->
      ...
      <xsl:apply-templates select="dc:source"                mode="plochc_p16998coll59"/>     <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:created"          mode="plochc_p16998coll59"/>     <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll59"/>     <!-- unwanted; remove                                           -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:format" mode="plochc_p16998coll59"/>

  <xsl:template match="dc:publisher" mode="plochc_p16998coll59"/>

  <xsl:template match="dc:source" mode="plochc_p16998coll59"/>

  <xsl:template match="dcterms:created" mode="plochc_p16998coll59"/>

  <xsl:template match="dcterms:extent" mode="plochc_p16998coll59"/>

  <xsl:template match="dcterms:license" mode="plochc_p16998coll59"/>

  <xsl:template match="dcterms:medium" mode="plochc_p16998coll59">
  ...
  <xsl:template match="dc:identifier" mode="plochc_p16998coll59">
    <xsl:choose>
  ...
  <xsl:template match="dc:contributor" mode="plochc_p16998coll59">
