...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">John Mathews Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:creator"          mode="mariettacollege_mathews"/>         <!-- create dcterms:creator                                     -->
      ...
      <xsl:apply-templates select="dcterms:spatial"     mode="mariettacollege_mathews"/>      <!-- create dcterms:spatial                                     -->
  ...
  <xsl:template match="dcterms:spatial" mode="mariettacollege_mathews">
  ...
  <xsl:template match="dc:creator" mode="mariettacollege_mathews">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
