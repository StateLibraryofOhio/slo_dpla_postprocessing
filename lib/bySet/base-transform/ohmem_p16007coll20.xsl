...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">John Sherman Manuscript Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="ohmem_p16007coll20"/>      <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:relation"              mode="ohmem_p16007coll20"/>      <!-- create dc:relation                                         -->
      ...
      <xsl:apply-templates select="dcterms:issued"           mode="ohmem_p16007coll20"/>      <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:requires"         mode="ohmem_p16007coll20"/>      <!-- unwanted; remove                                           -->

    </oai_qdc:qualifieddc>
  </xsl:template>


  <xsl:template match="dc:rights" mode="ohmem_p16007coll20">
    <xsl:choose>
  ...
  <xsl:template match="dcterms:requires" mode="ohmem_p16007coll20"/>

  <xsl:template match="dcterms:issued" mode="ohmem_p16007coll20"/>

  <xsl:template match="dc:relation" mode="ohmem_p16007coll20"/>
