...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Newsmakers</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="plochc_p16998coll48"/>     <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:creator"               mode="plochc_p16998coll48"/>     <!-- create dcterms:creator                                     -->
      <xsl:copy-of         select="dc:date"                  copy-namespaces="no"/>           <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="plochc_p16998coll48"/>     <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dcterms:alternative"      mode="plochc_p16998coll48"/>     <!-- create dcterms:alternative                                 -->
      <xsl:apply-templates select="dc:contributor"           mode="plochc_p16998coll48"/>     <!-- create dcterms:contributor                                 -->
      <xsl:apply-templates select="dc:description"           mode="odn"/>                     <!-- create dcterms:description                                 -->
      <xsl:apply-templates select="dcterms:extent"           mode="plochc_p16998coll48"/>     <!-- create dcterms:extent                                      -->
                                                                                              <!-- dcterms:identifier is created above as part of the edm:isShownAt transform -->
      <xsl:copy-of         select="dcterms:isReferencedBy"   copy-namespaces="no"/>           <!-- create IIIF metadata                                       -->
      <xsl:apply-templates select="dc:publisher"             mode="plochc_p16998coll48"/>     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="plochc_p16998coll48"/>     <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="odn"/>                     <!-- create dc:relation                                         -->
                                                                                              <!-- dc:rights is created above as part of the edm:rights transform -->
      <xsl:apply-templates select="dcterms:rightsHolder"     mode="plochc_p16998coll48"/>     <!-- create dcterms:rightsHolder                                -->
      <xsl:apply-templates select="dcterms:temporal"         mode="odn"/>                     <!-- create dcterms:temporal                                    -->

      <xsl:apply-templates select="dcterms:available"        mode="plochc_p16998coll48"/>     <!-- unwanted; remove                                           -->  
      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll48"/>     <!-- unwanted; remove                                           -->  
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll48"/>
      <xsl:apply-templates select="dcterms:tableOfContents"  mode="plochc_p16998coll48"/>


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:format" mode="plochc_p16998coll48"/>

  <xsl:template match="dc:publisher" mode="plochc_p16998coll48"/>

  <xsl:template match="dc:relation" mode="plochc_p16998coll48"/>

  <xsl:template match="dcterms:available" mode="plochc_p16998coll48"/>

  <xsl:template match="dcterms:extent" mode="plochc_p16998coll48"/>

  <xsl:template match="dcterms:license" mode="plochc_p16998coll48"/>

  <xsl:template match="dcterms:rightsHolder" mode="plochc_p16998coll48"/>

  <xsl:template match="dcterms:alternative" mode="plochc_p16998coll48">
  ...
  <xsl:template match="dc:creator" mode="plochc_p16998coll48">
    <xsl:for-each select="tokenize(., ';')">
  ...
  <xsl:template match="dc:contributor" mode="plochc_p16998coll48">
    <xsl:for-each select="tokenize(., ';')">
  ...
  <xsl:template match="dcterms:medium" mode="plochc_p16998coll48">
        <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:tableOfContents" mode="plochc_p16998coll48">
        <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:identifier" mode="plochc_p16998coll48">
    <xsl:choose>
