...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Jennie Jones Photography Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dcterms:spatial"          mode="clevelandstateu_jenniejones"/>           <!-- create dcterms:spatial                                     -->
  ...
  <xsl:template match="dcterms:spatial" mode="clevelandstateu_jenniejones">
