...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="text()|@*"/>
    <xsl:template match="//oai_dc:dc">
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">The Kenyon Reveille</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"       mode="reveille"/>           <!-- create edm:isShownAt -->
      <xsl:apply-templates select="dc:description"      mode="reveille"/>           <!-- create edm:preview   -->
      ...
      <xsl:apply-templates select="dc:date.created"     mode="reveille"/>           <!-- create dc:date                          -->
      ...
      <xsl:apply-templates select="dc:coverage.spatial" mode="reveille"/>           <!-- create dcterms:spatial                  -->
      ...
      <xsl:apply-templates select="dc:description.abstract"  mode="reveille"/>                <!-- create dcterms:description? -->
  ...
  <xsl:template match="dc:identifier" mode="reveille">
    <xsl:choose>
  ...
  <xsl:template match="dc:coverage.spatial" mode="reveille">
  ...
  <xsl:template match="dc:date.created" mode="reveille">
  ...
  <xsl:template match="dc:description" mode="reveille">
...
<!-- probably do not want this data.  Excising.  -->

<!--  <xsl:template match="dc:description.abstract" mode="reveille">
