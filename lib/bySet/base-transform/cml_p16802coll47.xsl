...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:apply-templates select="dc:language"              mode="cml_p16802coll47"/>        <!-- create dcterms:language                                    -->
      <xsl:apply-templates select="dc:creator"               mode="odn"/>                     <!-- create dcterms:creator                                     -->
      <xsl:apply-templates select="dc:date"                  mode="cml_p16802coll47"/>        <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="odn"/>                     <!-- create dc:format                                           -->
      <xsl:apply-templates select="dcterms:spatial"          mode="cml_p16802coll47"/>        <!-- create dcterms:spatial                                     -->
      <xsl:apply-templates select="dc:subject"               mode="odn"/>                     <!-- create dcterms:subject                                     -->
      <xsl:apply-templates select="dc:type"                  mode="cml_p16802coll47"/>        <!-- create dcterms:type                                        -->
      ...
      <xsl:apply-templates select="dcterms:extent"           mode="cml_p16802coll47"/>        <!-- create dcterms:extent                                      -->
      ...
      <xsl:apply-templates select="dcterms:isPartOf"         mode="cml_p16802coll47"/>        <!-- create dc:relation                                         -->
                                                                                              <!-- dc:rights is created above as part of the edm:rights transform -->
      <xsl:copy-of         select="dcterms:rightsHolder"     copy-namespaces="no"/>           <!-- create dcterms:rightsHolder                                -->
      <xsl:apply-templates select="dcterms:temporal"         mode="cml_p16802coll47"/>        <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:issued"           mode="cml_p16802coll47"/>        <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:coverage"         mode="cml_p16802coll47"/>        <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:medium"           mode="cml_p16802coll47"/>        <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dc:source"                mode="cml_p16802coll47"/>        <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:accessRights"     mode="cml_p16802coll47"/>
      <xsl:apply-templates select="dcterms:mediator"         mode="cml_p16802coll47"/>


    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dcterms:issued" mode="cml_p16802coll47"/>
  <xsl:template match="dcterms:temporal" mode="cml_p16802coll47"/>
  <xsl:template match="dcterms:medium" mode="cml_p16802coll47"/>
  <xsl:template match="dc:language" mode="cml_p16802coll47"/>
  <xsl:template match="dcterms:isPartOf" mode="cml_p16802coll47"/>
  <xsl:template match="dc:source" mode="cml_p16802coll47"/>
  <xsl:template match="dc:rights" mode="cml_p16802coll47"/>
  <xsl:template match="dcterms:mediator" mode="cml_p16802coll47"/>
  <xsl:template match="dc:type" mode="cml_p16802coll47"/>
  <xsl:template match="dcterms:extent" mode="cml_p16802coll47"/>

  <xsl:template match="dc:date" mode="cml_p16802coll47">
  ...
  <xsl:template match="dcterms:spatial" mode="cml_p16802coll47">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="(normalize-space(.) != '')">
  ...
  <xsl:template match="dc:coverage" mode="cml_p16802coll47">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="(normalize-space(.) != '')">
        <xsl:element name="dcterms:spatial" namespace="http://purl.org/dc/terms/">
          <xsl:value-of select="normalize-space(.)"/>
  ...
  <xsl:template match="dcterms:accessRights" mode="cml_p16802coll47">
    <xsl:for-each select="tokenize(., ';')">
