...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="text()|@*"/>
    <xsl:template match="//oai_dc:dc">
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Latinos in Rural America Interviews</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"              mode="kenyon_lkcaav"/>           <!-- create edm:isShownAt                 -->
      ...
      <xsl:apply-templates select="dc:date.created"            mode="kenyon_lkcaav"/>
      ...
      <xsl:apply-templates select="dc:coverage.spatial.lat"    mode="kenyon_lkcaav"/>           <!-- create dcterms:spatial                    -->
      <xsl:apply-templates select="dc:subject"                 mode="kenyon_lkcaav"/>           <!-- create dcterms:subject                    -->
      ...
      <xsl:apply-templates select="dc:description"             mode="kenyon_lkcaav"/>           <!-- create dcterms:description                -->
  ...
  <xsl:template match="dc:coverage.spatial.lat" mode="kenyon_lkcaav">
  ...
  <xsl:template match="dc:date.created" mode="kenyon_lkcaav">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_lkcaav">
    <xsl:if test="not(normalize-space(.)='') and contains(., lower-case('https://digital.kenyon.edu/lkca_audio_video/'))">
  ...
  <xsl:template match="dc:subject" mode="kenyon_lkcaav">
  ...
  <xsl:template match="dc:description" mode="kenyon_lkcaav">
