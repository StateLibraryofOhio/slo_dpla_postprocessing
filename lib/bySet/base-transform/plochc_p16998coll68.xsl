...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Union Baptist Church</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:date"                  mode="plochc_p16998coll68"/>     <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="plochc_p16998coll68"/>     <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dcterms:alternative"      mode="plochc_p16998coll68"/>     <!-- create dcterms:alternative                                 -->
      ...
      <xsl:apply-templates select="dcterms:extent"           mode="plochc_p16998coll68"/>     <!-- create dcterms:extent                                      -->
      ...
      <xsl:apply-templates select="dc:publisher"             mode="plochc_p16998coll68"/>     <!-- create dcterms:publisher                                   -->
      <xsl:apply-templates select="dc:relation"              mode="plochc_p16998coll68"/>     <!-- create dc:relation                                         -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="odn"/>                     <!-- create dc:relation                                         -->
                                                                                              <!-- dc:rights is created above as part of the edm:rights transform -->
      <xsl:apply-templates select="dcterms:rightsHolder"     mode="plochc_p16998coll68"/>     <!-- create dcterms:rightsHolder                                -->
      ...
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll68"/>
      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll68"/>
  ...
  <xsl:template match="dc:relation" mode="plochc_p16998coll68"/>

  <xsl:template match="dc:format" mode="plochc_p16998coll68"/>

  <xsl:template match="dcterms:extent" mode="plochc_p16998coll68"/>

  <xsl:template match="dc:publisher" mode="plochc_p16998coll68"/>

  <xsl:template match="dcterms:license" mode="plochc_p16998coll68"/>

  <xsl:template match="dcterms:rightsHolder" mode="plochc_p16998coll68"/>

  <xsl:template match="dcterms:medium" mode="plochc_p16998coll68">
  ...
  <xsl:template match="dc:date" mode="plochc_p16998coll68">
  ...
  <xsl:template match="dcterms:alternative" mode="plochc_p16998coll68">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
