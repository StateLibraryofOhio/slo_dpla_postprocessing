...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="odn_templates.xsl"/>
    ...
    <xsl:template match="//oai_dc:dc">
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Introductory Chemistry Laboratory Course Instructional Videos</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"       mode="kenyon_introchemvid"/>     <!-- create edm:isShownAt, edm:preview, and dcterms:identifier -->
      ...
      <xsl:apply-templates select="dc:date.created"     mode="kenyon_introchemvid"/>     <!-- create dc:date                          -->
  ...
  <xsl:template match="dc:date.created" mode="kenyon_introchemvid">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_introchemvid">
    <xsl:choose>
