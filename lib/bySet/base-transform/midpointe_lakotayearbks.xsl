...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Lakota and Liberty-Union School District High School Yearbooks</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="midpointe_lakotayearbks"/> <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:format"                mode="midpointe_lakotayearbks"/> <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dc:coverage"              mode="midpointe_lakotayearbks"/>

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:identifier" mode="midpointe_lakotayearbks">
    <xsl:choose>
  ...
  <xsl:template match="dc:coverage" mode="midpointe_lakotayearbks">
