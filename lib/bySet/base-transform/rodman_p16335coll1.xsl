...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Greater Alliance Carnation Festival</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="rodman_p16335coll1"/>      <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:coverage"              mode="rodman_p16335coll1"/>      <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:license"          mode="rodman_p16335coll1"/>      <!-- unwanted; remove                                           -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:coverage" mode="rodman_p16335coll1"/>

  <xsl:template match="dcterms:license" mode="rodman_p16335coll1"/>
  ...
  <xsl:template match="dc:identifier" mode="rodman_p16335coll1">
    <xsl:choose>
