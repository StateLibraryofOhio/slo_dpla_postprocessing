...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Troy Township</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="delawaremem_troy"/>        <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:subject"               mode="delawaremem_troy"/>        <!-- create dcterms:subject                                     -->
  ...
  <xsl:template match="dc:subject" mode="delawaremem_troy">
  ...
  <xsl:template match="dc:identifier" mode="delawaremem_troy">
    <xsl:choose>
