...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:apply-templates select="dc:rights"                mode="delawaremem_yearbooks"/>   <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:subject"               mode="delawaremem_yearbooks"/>   <!-- create dcterms:subject                                     -->
      <xsl:apply-templates select="dc:type"                  mode="delawaremem_yearbooks"/>   <!-- create dcterms:type                                        -->
  ...
  <xsl:template match="dc:identifier" mode="delawaremem_yearbooks">
    <xsl:choose>
  ...
  <xsl:template match="dc:type" mode="delawaremem_yearbooks">
    <xsl:for-each select=".">
      <xsl:for-each select="tokenize(., '&#xA;')">
        <xsl:choose>
  ...
  <xsl:template match="dc:rights" mode="delawaremem_yearbooks">
    <xsl:for-each select="tokenize(., '&#xA;')">
