...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Community Voices of the Native American Indian Center of Central Ohio</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="kenyon_commvoicesoh"/>     <!-- create edm:isShownAt                 -->
      ...
      <xsl:apply-templates select="dc:date.created"          mode="kenyon_commvoicesoh"/>     <!-- create dc:date                            -->
      ...
      <xsl:apply-templates select="dc:description.abstract"  mode="kenyon_commvoicesoh"/>     <!-- create dcterms:description                -->
  ...
  <xsl:template match="dc:date.created" mode="kenyon_commvoicesoh">
    <xsl:element namespace="http://purl.org/dc/elements/1.1/" name="dc:date">
      <xsl:value-of select="substring-before(normalize-space(.),'T')"/>
    </xsl:element>
  </xsl:template>

  <xsl:template match="dc:description.abstract" mode="kenyon_commvoicesoh">
  ...
  <xsl:template match="dc:identifier" mode="kenyon_commvoicesoh">
    <xsl:choose>
