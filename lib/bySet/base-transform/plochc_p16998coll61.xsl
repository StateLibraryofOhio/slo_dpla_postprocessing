...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Thomas Cottrell Collection of Bills of Lading and Freight Receipts</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP fields -->
      <xsl:apply-templates select="dc:identifier"            mode="plochc_p16998coll61"/>     <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dcterms:medium"           mode="plochc_p16998coll61"/>     <!-- create dc:format                          -->
      <xsl:apply-templates select="dcterms:spatial"          mode="plochc_p16998coll61"/>     <!-- create dcterms:spatial                    -->
      ...
      <xsl:apply-templates select="dc:description"           mode="plochc_p16998coll61"/>     <!-- create dcterms:description                -->
      ...
      <xsl:apply-templates select="dc:source"                mode="plochc_p16998coll61"/>     <!-- unwanted; remove                          -->
      <xsl:apply-templates select="dcterms:license"          mode="plochc_p16998coll61"/>     <!-- unwanted; remove                          -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="plochc_p16998coll61"/>     <!-- unwanted; remove                          -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:publisher" mode="plochc_p16998coll61"/>

  <xsl:template match="dc:source" mode="plochc_p16998coll61"/>

  <xsl:template match="dcterms:extent" mode="plochc_p16998coll61"/>

  <xsl:template match="dcterms:isPartOf" mode="plochc_p16998coll61"/>

  <xsl:template match="dcterms:license" mode="plochc_p16998coll61"/>
  ...
  <xsl:template match="dc:identifier" mode="plochc_p16998coll61">
    <xsl:choose>
