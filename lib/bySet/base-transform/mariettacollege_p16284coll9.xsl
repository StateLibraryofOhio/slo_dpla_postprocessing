...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">Marietta College</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Thomas Dwight Biscoe Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dcterms:spatial"          mode="mariettacollege_p16824coll9"/>  <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dcterms:isPartOf"         mode="mariettacollege_p16824coll9"/>    <!-- create dc:relation                                         -->
      ...
      <xsl:apply-templates select="dcterms:hasFormat"        mode="mariettacollege_p16824coll9"/>   <!-- create dc:format                                     -->

      <xsl:apply-templates select="dcterms:created"          mode="mariettacollege_p16824coll9"/>   <!-- create dc:date                                       -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dcterms:isPartOf" mode="mariettacollege_p16824coll9"/>

  <xsl:template match="dcterms:hasFormat" mode="mariettacollege_p16824coll9">
  ...
  <xsl:template match="dcterms:spatial" mode="mariettacollege_p16824coll9">
  ...
  <xsl:template match="dcterms:created" mode="mariettacollege_p16824coll9">
