...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Cantigny 1st Division Oral History Project phase II</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dcterms:spatial"          mode="ohiou_cantigny"/>          <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dcterms:isPartOf"         mode="ohiou_cantigny"/>          <!-- create dc:relation                                         -->
  ...
  <xsl:template match="dcterms:rightsHolder" mode="ohiou_cantigny">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
