...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Angelique (Le Petit) Martin Papers</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dcterms:spatial"    mode="mariettacollege_martin"/>        <!-- create dcterms:spatial                                     -->
  ...
  <xsl:template match="dcterms:spatial" mode="mariettacollege_martin">
