...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Frances Prindle Taft Collection</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="cleveart_p17142coll9"/>    <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      <xsl:apply-templates select="dc:rights"                mode="cleveart_p17142coll9"/>    <!-- create edm:rights    and dc:rights                         -->
      ...
      <xsl:apply-templates select="dc:subject"               mode="cleveart_p17142coll9"/>    <!-- create dcterms:subject                                     -->
      ...
      <xsl:apply-templates select="dc:source"                mode="cleveart_p17142coll9"/>    <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:bibliographicCitation"   mode="cleveart_p17142coll9"/>   <!-- unwanted; remove                                     -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="cleveart_p17142coll9"/>

  <xsl:template match="dcterms:bibliographicCitation" mode="cleveart_p17142coll9"/>
  

  <xsl:template match="dc:subject" mode="cleveart_p17142coll9">
  ...
  <xsl:template match="dc:rights" mode="cleveart_p17142coll9">
    <xsl:choose>
  ...
  <xsl:template match="dc:identifier" mode="cleveart_p17142coll9">
    <xsl:choose>
