...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">William E. Peters Papers</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:date"                  mode="ohiou_wepeters"/>          <!-- create dc:date                                             -->
      <xsl:apply-templates select="dc:format"                mode="ohiou_wepeters"/>          <!-- create dc:format                                           -->
      <xsl:apply-templates select="dcterms:spatial"          mode="ohiou_wepeters"/>          <!-- create dcterms:spatial                                     -->
      ...
      <xsl:apply-templates select="dc:contributor"           mode="ohiou_wepeters"/>          <!-- create dcterms:contributor                                 -->
      ...
      <xsl:apply-templates select="dc:source"                mode="ohiou_wepeters"/>          <!-- unwanted; eliminate                                        -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="ohiou_wepeters"/>          <!-- unwanted; eliminate                                        -->
      <xsl:apply-templates select="dcterms:tableOfContents"  mode="ohiou_wepeters"/>          <!-- unwanted; eliminate                                        -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dc:source" mode="ohiou_wepeters" />
  <xsl:template match="dcterms:isPartOf" mode="ohiou_wepeters" />
  <xsl:template match="dcterms:tableOfContents" mode="ohiou_wepeters" />
   
  <xsl:template match="dc:contributor" mode="ohiou_wepeters">
  ...
  <xsl:template match="dc:date" mode="ohiou_wepeters">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dc:format" mode="ohiou_wepeters">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
  ...
  <xsl:template match="dcterms:spatial" mode="ohiou_wepeters">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="normalize-space(.) != ''">
