...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_dc:dc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">The Burr</xsl:element>              <!-- create dcterms:isPartOf -->

      <!-- REQUIRED ODN-MAP FIELDS -->
      <xsl:apply-templates select="dc:identifier"            mode="kent_theburr"/>            <!-- create edm:isShownAt, edm:preview, and dcterms:identifier  -->
      ...
      <xsl:apply-templates select="dc:format"                mode="kent_theburr"/>            <!-- create dc:format                                           -->
      ...
      <xsl:apply-templates select="dc:source"                mode="kent_theburr"/>            <!-- unwanted; remove                                           -->
  ...
  <xsl:template match="dc:description" mode="kent_theburr">
    <xsl:choose>
