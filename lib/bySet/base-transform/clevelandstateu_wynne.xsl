...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="edm:dataProvider" namespace="http://www.europeana.eu/schemas/edm/">Cleveland State University</xsl:element>     <!-- create edm:dataProvider -->
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">William Wynne Photography Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:source"                mode="clevelandstateu_wynne"/>   <!-- eliminate dc:source -->
      <xsl:apply-templates select="dcterms:isPartOf"         mode="clevelandstateu_wynne"/>   <!-- eliminate dcterms:isPartOf -->
