...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="//oai_qdc:qualifieddc">
    <oai_qdc:qualifieddc
      ...
      <xsl:element name="dcterms:isPartOf" namespace="http://purl.org/dc/terms/">Ohio Postcard Collection</xsl:element>              <!-- create dcterms:isPartOf -->
      ...
      <xsl:apply-templates select="dc:rights"                mode="cml_postcard"/>            <!-- create edm:rights    and dc:rights                         -->
      <xsl:apply-templates select="dcterms:accessRights"     mode="cml_postcard"/>            <!-- create edm:rights                                          -->
      ...
      <xsl:apply-templates select="dc:type"                  mode="cml_postcard"/>            <!-- create dcterms:type                                        -->
      ...
      <xsl:apply-templates select="dcterms:temporal"         mode="cml_postcard"/>            <!-- create dcterms:temporal                                    -->
      <xsl:apply-templates select="dc:coverage"              mode="cml_postcard"/>            <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:medium"           mode="cml_postcard"/>            <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:isVersionOf"      mode="cml_postcard"/>            <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:created"          mode="cml_postcard"/>            <!-- unwanted; remove                                           -->
      <xsl:apply-templates select="dcterms:provenance"       mode="cml_postcard"/>            <!-- unwanted; remove                                           -->

    </oai_qdc:qualifieddc>
  </xsl:template>

  <xsl:template match="dcterms:temporal" mode="cml_postcard"/>
  <xsl:template match="dcterms:medium" mode="cml_postcard"/>
  <xsl:template match="dcterms:isPartOf" mode="cml_postcard"/>
  <xsl:template match="dc:rights" mode="cml_postcard"/>
  <xsl:template match="dcterms:mediator" mode="cml_postcard"/>
  <xsl:template match="dcterms:isVersionOf" mode="cml_postcard"/>
  <xsl:template match="dcterms:extent" mode="cml_postcard"/>
  ...
  <xsl:template match="dc:coverage" mode="cml_postcard">
    <xsl:for-each select="tokenize(., ';')">
      <xsl:if test="(normalize-space(.) != '')">
        <xsl:element name="dcterms:spatial" namespace="http://purl.org/dc/terms/">
          <xsl:value-of select="normalize-space(.)"/>
  ...
  <xsl:template match="dcterms:accessRights" mode="cml_postcard">
    <xsl:for-each select="tokenize(., ';')">
